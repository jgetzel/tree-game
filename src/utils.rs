use crate::init_systems::{AutoSizeOnY, AutoSortOnY, YOffset, TRUNK_SCALE};
use bevy::hierarchy::{BuildChildren, Children};
use bevy::math::Vec3;
use bevy::prelude::{default, Commands, Entity, Query, Transform, TransformBundle, With, Without};
